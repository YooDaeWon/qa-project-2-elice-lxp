...
> 📌 본 저장소는 엘리스트랙 QA 6기 최종 팀 프로젝트(4팀 시스루)의 GitLab 저장소를 포트폴리오 보관용으로 이관한 것입니다.
> 테스트 대상인 Elice LXP(Dev) 서버는 교육 과정 종료 후 접근이 제한될 수 있어, 현재는 테스트 코드 실행이 불가할 수 있습니다.
> 실행 결과는 [10. 테스트 결과 및 산출물](#10-테스트-결과-및-산출물)에서 확인할 수 있습니다.
